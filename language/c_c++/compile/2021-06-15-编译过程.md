    ...
    subgraph 处理规则
        ...
        A(预处理器cpp)
            ...
            A --> D(处理#include, 插入被包含文件)
                D --> D1(后更尖括号表示在编译器所设置include路径内搜索)
                D --> D2(后跟双引号表示在包含当前include指令文件所在目录夹内搜索)
            A --> E(删除所有注释)
...
![](/assets/image/20241108_221228.jpg)

![](/assets/image/20241106_233203.jpg)
...
![](/assets/image/20241108_221711.jpg)
...
![](/assets/image/20241108_223929.jpg)
...
![](/assets/image/20241108_233723.jpg)
